...
const AdvanceRequestApp = () => {
  ...
  // Example: get user role from global/window or default
  const userRole = window.userRole || 'accountant'; // Change this accordingly

  // Updated form data with month and year instead of termId
  ...
  console.log('getEmployeeName input:', employee);
  console.log('employees array:', employees);

  if (!employee) return 'Unknown Employee';

  if (typeof employee === 'string') {
    const found = employees.find(emp => emp._id === employee);
    console.log('Found employee by ID:', found);
  ...
  if (typeof employee === 'object' && employee.firstName && employee.lastName) {
    console.log('Employee object with names:', employee);
  ...
  return (
    <div className="app-container">
      ...
      <div className="content-section">
        {activeTab === 'request' && userRole === 'accountant' && (
